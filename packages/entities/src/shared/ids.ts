...
export type PositionIntentId = Uuid<'PositionIntentId'>;
export type StartupRatingId = Uuid<'StartupRatingId'>;
export type RatingItemId = Uuid<'RatingItemId'>;
...
export const positionIntentId = uuid.transform((v) => v as PositionIntentId);
export const startupRatingId = uuid.transform((v) => v as StartupRatingId);
export const ratingItemId = uuid.transform((v) => v as RatingItemId);
